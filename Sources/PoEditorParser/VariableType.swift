...
extension VariableType {
    ...
    init(string: String) {
        ...
        let variablesForNumbersThatShouldBeAString = ["line_number", "phone_number"]
        let tests = [ { str.contains("number") && variablesForNumbersThatShouldBeAString.filter(str.contains).isEmpty }]
